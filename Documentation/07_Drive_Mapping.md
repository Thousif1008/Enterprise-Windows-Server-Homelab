...
A Group Policy Preference was configured to map the IT shared folder as a network drive. This allows users in the IT department to access the shared folder automatically after signing in.
